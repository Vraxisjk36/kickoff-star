...
export const COMPETITION_DEFINITIONS: Record<string, CompetitionDefinition> = {
  ...
  academyChampionsCup: { id: 'academyChampionsCup', name: 'Continental Academy Champions Cup', format: 'group-knockout', category: 'academy', level: 'international', prestige: 82, eligibility: { minAge: 15, maxAge: 19, academyPlayersAllowed: true, requiresInjuryClearance: true }, yellowCardsForBan: 3 },
