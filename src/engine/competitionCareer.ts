...
export const COMPETITION_DEFINITIONS: Record<string, CompetitionDefinition> = {
  ...
  schoolCup: { id: 'schoolCup', name: 'Regional Schools Cup', format: 'knockout', category: 'school', level: 'regional', prestige: 48, eligibility: { minAge: 14, maxAge: 18, schoolRegistered: true, academyPlayersAllowed: false, requiresInjuryClearance: true }, yellowCardsForBan: 3 },
  nationalChampionship: { id: 'nationalChampionship', name: 'National Schools Championship', format: 'knockout', category: 'selection', level: 'national', prestige: 72, eligibility: { minAge: 14, maxAge: 18, schoolRegistered: true, academyPlayersAllowed: false, requiresInjuryClearance: true }, yellowCardsForBan: 2 },
  ...
  academyChampionsCup: { id: 'academyChampionsCup', name: 'Academy Champions Cup', format: 'knockout', category: 'academy', level: 'international', prestige: 82, eligibility: { minAge: 15, maxAge: 19, academyPlayersAllowed: true, requiresInjuryClearance: true }, yellowCardsForBan: 2 },
