...
export const COMPETITION_DEFINITIONS: Record<string, CompetitionDefinition> = {
  ...
  octoberDevelopment: { id: 'octoberDevelopment', name: 'October Development Series', format: 'friendly', category: 'grassroots', level: 'local', prestige: 28, eligibility: { minAge: 14, maxAge: 15, academyPlayersAllowed: false, requiresInjuryClearance: true }, yellowCardsForBan: 3 },
